...
Partial Class FrmUpdate
    ...
    Private Sub InitializeComponent()
        ...
        Me.picUpdating.Image = Global.Rebar_Weight.My.Resources.Resources.gUpdate
    ...
    Public WithEvents pnlProgressBar As Panel
    Public WithEvents lblPercent As Label
    Private WithEvents lblText As Label
    Private WithEvents picUpdating As PictureBox
    Public WithEvents lblCapacity As Label
